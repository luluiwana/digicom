    ...
    <div class="row ">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" action="<?= base_url('surat/' . $ctrl) ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="control-label">Jenis
                                        Instansi</label>
                                    <div>
                                        <input type="text" name="jenis_instansi" class="form-control" value="" placeholder="contoh : dinas pendidikan kota malang">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="control-label">Nama Instansi</label>
                                    <div>
                                        <input type="text" name="nama_instansi" class="form-control" value="" placeholder="contoh: PT. Induk Jaya">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea type="text" name="alamat_instansi" class="form-control" value=""> </textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="email" name="email" class="form-control" value="" placeholder="contoh : smkn8malang@gmail.com">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="text-dark mb-4 h4 bg-gradient-success ml--4 text-white p-2 col-md-3">Header Surat</div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <!-- wajib  -->
                        ...
                        <div class="form-group col-12 p-0">
                            <label for="" class="control-label">Ucapan Pembuka</label>
                            <div>
                                <div class="">
                                    <input type="text" placeholder="Yth Bapak/Ibu Kepala Dinas" name="ucapan" class="form-control"> </input>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" class="control-label">Nomor Identitas (NIP)</label>
                                    <div>
                                        <input type="text" name="nip" placeholder="contoh: 357889856790" class="form-control">
                                        <!-- <input type="hidden" name="tipe" value="Hanging" class="form-control"> -->
                                    </div>
                                </div>
                            </div>
