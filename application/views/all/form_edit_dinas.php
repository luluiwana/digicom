...
<div class="container-fluid mt-3">
    ...
    <div class="row ">
        <div class="col-md-12">
            <a href="<?=base_url()?>siswa/lihat_tugas/<?=$id_tugas?>" class="btn btn-outline-primary btn-sm mb-4"><i
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" action="<?= base_url('surat/update_surat/'.$row->id_surat) ?>" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="control-label">Jenis
                                        Instansi</label>
                                    <div>
                                        <input type="text" name="jenis_instansi" class="form-control" value="<?=$row->jenis_instansi?>"
                                            >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea type="text" name="alamat_instansi" class="form-control"
                                            value="" placeholder="Jalan Soekarno-Hatta No.18 Kota Malang"><?=$row->alamat_instansi?> </textarea>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                        ...
                        <div class="form-group col-12 p-0">
                            ...
                            <div>
                                <div class="">
                                    <input type="text"  value="<?=$row->penerima?>" name="penerima"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="nama" value="<?=$row->pengirim?>" 
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="nip" value="<?=$row->nomor_identitas?>" 
                                            class="form-control">
                                        <!-- <input type="hidden" name="tipe" value="Hanging" class="form-control"> -->
                                    </div>
                                </div>
