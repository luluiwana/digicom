...
<div class="container-fluid mt-3">
    <div class="row ">
        <div class="col-md-12">
            <a href="<?= base_url($level . '/buat_surat/' . $id_tugas) ?>" class="btn btn-outline-primary btn-sm mb-4"><i class="fas fa-chevron-left mr-1"></i>Kembali</a>
            <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="nama_instansi" class="form-control" value="" placeholder="PT MATAHARI PUTRA PRIMA">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="" class="control-label">Alamat Lengkap Instansi (Beserta kode pos)</label>
                                    <div class="">
                                        <textarea type="text" name="alamat_instansi" class="form-control" value="" placeholder="Jalan Basuki Rahmat No.11 Tulungagung "> </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="control-label">Telp /
                                        HP</label>
                                    <div>
                                        <input type="text" name="telp" class="form-control" value="" placeholder="contoh: (031) 47189xxx ">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="control-label">Website</label>
                                    <div>
                                        <input type="text" name="website" class="form-control" value="" placeholder="contoh: www.matahariputraprima.com">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="email" name="email" class="form-control" value="" placeholder="contoh : email@email.com">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="perihal" class="form-control" value="" placeholder="contoh: Pesanan Barang">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" placeholder="contoh: Yth. Direktur " name="penerima" class="form-control"> </input>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="instansi_tujuan" class="form-control" value="" placeholder="contoh: PT Makmur Jaya">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="kode_pos" class="form-control" value="" placeholder="contoh: 63152">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" name="jabatan" placeholder="contoh: Manajer Pemasaran" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
