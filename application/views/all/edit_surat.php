...
<div class="container-fluid mt-3">
    <div class="row ">
        <div class="col-md-12">
        <a href="<?=base_url($level.'/preview')?>" class="btn btn-outline-primary btn-sm mb-4"><i class="fas fa-chevron-left mr-1"></i>Kembali</a>
            <div class="card">
                <div class="card-header text-center  h3"><b>Surat Dinas (Hanging)</b></div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="kop_surat" class="form-control"
                                        placeholder="contoh: PT. Induk Jaya" value="Nama Instansi">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="jenis_instansi" class="form-control" 
                                        placeholder="" value="Jenis Instansi">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="control-label">Alamat</label>
                                <div class="">
                                    <textarea type="text" name="alamat" class="form-control" value="Alamat"> </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="control-label">Kota</label>
                                <div>
                                    <input type="text" name="kota" class="form-control" value="Malang"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="control-label">Telp /
                                    HP</label>
                                <div>
                                    <input type="text" name="telp" class="form-control" value="08678767"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="website" class="form-control" value="google.com"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="lampiran" class="form-control" value="Lampiran" placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="control-label">Nama
                                    Instansi</label>
                                <div>
                                    <input type="text" name="nama_tujuan" class="form-control" value="Nama Instansi"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="control-label">Kota</label>
                                <div>
                                    <input type="text" name="kota_tujuan" class="form-control" value="Medan"
