            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <h1>Digital Corespondence Management</h1>
                        <a href="<?=base_url('auth/login')?>" class="main-button-slider">Login</a>
                        <a href="<?=base_url('auth/daftar')?>" class="main-button-slider">Daftar Sekarang</a>
            ...
            <div class="row">
                ...
                <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                    <div class="left-heading">
                        <h5>Tentang Digital Corespondence Management</h5>
                    </div>
                    <div class="left-text">
                        <p>Digital Corespondence Management merupakan aplikasi praktikum manajemen korespondensi digital
                            yang dikembangkan oleh
                            Prodi S1 Pendidikan Administrasi Perkantoran, Fakultas Ekonomi, Universitas Negeri Malang
                        </p>
                        <a href="<?=base_url('auth/login')?>" class="main-button">Login</a>
                        <a href="<?=base_url('auth/daftar')?>" class="main-button-slider">Daftar Sekarang</a>
