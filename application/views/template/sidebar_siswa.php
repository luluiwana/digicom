   ...
   <div class="scrollbar-inner">
     ...
     <div class="sidenav-header  align-items-center">
       <a class="navbar-brand" href="<?= base_url('siswa') ?>">
         <img src="<?= base_url('assets/img/brand/DIGCOM.png') ?>" class="navbar-brand-img" alt="...">
       </a>
     </div>
         ...
         <ul class="navbar-nav">
           ...
           <li class="nav-item">
             <a class="nav-link <?php if ($title == 'Materi') {
                                  echo 'active';
                                } ?>" href="<?= base_url('siswa/materi') ?>"">
                <i class=" ni ni-planet text-primary"></i>
               <span class="nav-link-text">Materi</span>
             </a>
           </li>
           <li class="nav-item">
             <a class="nav-link <?php if ($title == 'Tugas') {
                                  echo 'active';
                                } ?>" href="<?= base_url('siswa/tugas') ?>">
               <i class="ni ni-email-83 text-primary"></i>
               <span class="nav-link-text">Tugas</span>
             </a>
           </li>
           <li class="nav-item">
             <a class="nav-link <?php if ($title == 'Profil') {
                                  echo 'active';
                                } ?>" href="<?= base_url('siswa/profil') ?>">
